        ...
        <section class="max-w-4xl mx-auto space-y-20">
            ...
            <div class="space-y-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="p-1 rounded-2xl bg-gradient-to-b from-cyber-blue/20 to-transparent">
                        <div class="bg-deep-space p-8 rounded-[calc(1rem-1px)] h-full space-y-6">
                            <div class="flex items-center gap-6">
                                <div class="w-24 h-24 rounded-full border-2 border-cyber-blue/50 bg-cyber-blue/10 flex items-center justify-center overflow-hidden shadow-[0_0_15px_rgba(0,212,255,0.2)]">
                                    <svg class="w-12 h-12 text-cyber-blue animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                </div>
                                <div>
                                    <h3 class="text-2xl font-bold text-white font-orbitron tracking-tight">KORTANA</h3>
                                    <p class="text-cyber-blue font-mono text-xs uppercase tracking-widest">Head of DevSecOps & Architecture</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3">
                                <span class="text-[10px] font-mono px-2 py-1 bg-white/5 text-slate-500 rounded">RUST_EXPERT</span>
                                <span class="text-[10px] font-mono px-2 py-1 bg-white/5 text-slate-500 rounded">SYSTEM_MASTER</span>
                                <span class="text-[10px] font-mono px-2 py-1 bg-white/5 text-slate-500 rounded">GRC_STRATEGIST</span>
                            </div>
                        </div>
                    </div>

                    <div class="p-8 rounded-2xl border border-dashed border-white/10 flex flex-col items-center justify-center text-center space-y-4 opacity-50">
                        ...
                        <p class="font-orbitron text-xs tracking-widest uppercase">Próximo Operador</p>
                    </div>
                </div>
            </div>
...
def main():
    ...
    with open(path, "w", encoding="utf-8") as f:
        f.write(CONTENT_SOBRE_UPDATED)
    print(f"✅ Página Sobre atualizada com a Seção de Time e Perfil da Kortana em: {path}")
